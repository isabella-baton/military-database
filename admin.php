<?php
    ...
    $assignedItemsQuery = "SELECT b.barcodeID, e.employeeID, i.name, e.first_name, e.last_name, a.due_date, GREATEST(DATEDIFF(CURDATE(), a.due_date), 0) AS days_overdue
                           FROM assigned_to a
                ...
                <tbody>
                    <?php foreach ($items as $item): ?>
                        <tr>
                            ...
                            <td> <?php echo htmlspecialchars($item['max_checkout_days']); ?> </td>
                            <td>
